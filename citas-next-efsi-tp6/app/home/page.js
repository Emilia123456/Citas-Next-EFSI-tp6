...
export default function Page() {
  ...
  const textoBienvenida = `
    ...
    En la Clínica Veterinaria [Nombre], tu mascota siempre está en buenas manos. ¡Esperamos conocerte a ti y a tu peludo amigo pronto!
      `;
